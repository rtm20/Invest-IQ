                  ...
                  <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-4 border-2 border-green-200 dark:border-green-600">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          <p className="text-sm font-semibold text-gray-900 dark:text-white">No Data Storage</p>
                          <p className="text-xs text-gray-600 dark:text-gray-400">Documents processed, not saved</p>
                        </div>
                      </div>
                    </div>
                  </div>
